...
class Admin extends CI_Controller {
  ...
  public function enrol_student($param1 = "") {
    ...
    if ($param1 == 'enrol') {     
      $this->crud_model->enrol_a_student_manually($data['email']);
  ...
  public function orders() {
    ...
    $page_data['new_order'] = $this->user_model->get_all_orders();
    $this->load->view('backend/index', $page_data);
  }
  ...
  public function update_order_status(){   
      ...
      $this->crud_model->update_order($order_id);
      $this->session->set_flashdata('flash_message', get_phrase('order_success'));
      redirect(site_url('admin/orders'), 'refresh');
  }
  ...
  public function refund() {
    ...
    $page_data['all_refund'] = $this->user_model->get_all_refund();
    $this->load->view('backend/index', $page_data);
  }
  ...
  public function intructors() {
    ...
    $page_data['page_name'] = 'instructors_list';
    $page_data['page_title'] = get_phrase('instructors');
    $page_data['users'] = $this->user_model->get_all_instructor($param2);
    $this->load->view('backend/index', $page_data);
  }
