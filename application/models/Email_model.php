...
class Email_model extends CI_Model {
	...
	public function send_purchase_notification_mail($cart_items = ""){
		...
		$purchase_msg	.=	"<strong style='margin-top: 20px; font-size: 14px;'>Purchased Course:</strong><br><br>";
		...
		$purchase_msg	.= "<span style='font-size: 18px;'>&#8226;</span><strong style='font-size: 14px;'> ".$course_details['title']."</strong><br>";
		}
		$purchase_msg 	.= 	"<br><strong style='margin-top: 20px; font-size: 14px;'>Customer Details:</strong><br><br>";
