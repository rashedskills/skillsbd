                    ...
                    <div class="user-dashboard-sidebar">
                        ...
                        <div class="user-dashboard-menu">
                            <ul>
                                ...
                                <li class="active"><a href="<?php echo site_url('home/profile/user_photo'); ?>"><?php echo get_phrase('photo_/_logo'); ?></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="user-dashboard-content">
                        <div class="content-title-box">
                            <div class="title"><?php echo get_phrase('profile_photo_or_logo'); ?></div>
                            <div class="subtitle"><?php echo get_phrase('update_your_profile_photo_or_logo'); ?>.</div>
                        </div>
