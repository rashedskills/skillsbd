...
.intructor-banner-area {
    background-image: url('../assets/backend/images/providers.jpg');
        ...
        <div class="row">
            <div class="col">
                <div class="home-banner-wrap">
                    <h2 style="font-weight: normal">Advertise your course with us</h2>
                    <p>Create your account and share your courses with thousand of students today.</p>                    
                    <a class="btn" href="<?php echo site_url('home/login'); ?>">Create an Account</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container py-3">
        ...
        <div class="row mb-5">
            <div class="col-md-3 col-sm-12 text-center">
                <i class="fas fa-clock mb-4" style="font-size: 3rem; color: #8991a5"></i>
                <h5 class="mb-2">Course live within minutes</h5>
                <p>Posting a course to skillsbd.com is fast, easy and free.</p>
            </div>
            <div class="col-md-3 col-sm-12 text-center">
                <i class="fas fa-handshake mb-4" style="font-size: 3rem; color: #8991a5"></i>
                <h5 class="mb-2">Build trust</h5>
                <p>Sponsor content on skillsbd.com Build trust and consideration among candidates.</p>
            </div>
            <div class="col-md-3 col-sm-12 text-center">
                <i class="fas fa-envelope mb-4" style="font-size: 3rem; color: #8991a5"></i>
                <h5 class="mb-2">Email our course seekers</h5>
                <p>Schedule emails to skillsbd.com’s audience, putting your courses in front of the right candidates.</p>
            </div>
            <div class="col-md-3 col-sm-12 text-center">
                <i class="fas fa-eye mb-4" style="font-size: 3rem; color: #8991a5"></i>
                <h5 class="mb-2">Boost your visibility</h5>
                <p>Promote your brand to skillsbd.com users.</p>
            </div>
        </div>        
    </div>
</section>
...
<section class="category-course-list-area" style="background-color: #36373c; color: #ffdd00;">
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <i class="fas fa-user-graduate mb-4" style="font-size: 3rem;"></i>
                <h1>10K+</h1>
                <p>Potential students</p>
            </div>
            <div class="col-md-4 text-center">
                <i class="fas fa-search mb-4" style="font-size: 3rem;"></i>
                <h1>1K+</h1>
                <p>Course enquiries per month</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container py-5">
        ...
        <div class="row mb-3">
            ...
            <h6><strong>What's included in a Skillsbd class?</strong></h6>
                <p>Skillsbd classes include a combination of video lessons, quizes and a class project. The class project is a short assignment that helps students put their new skills into action.</p>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
        ...
        <div class="row">
            ...
            <h6><strong>Can I create more than one course?</strong></h6>
                <p>Yes! as an Instructor or Institute you can create any amount of classes as per as skillsbd <a href="<?php echo site_url('home/privacy_policy') ?>" class="info-text">privacy and policy</a>.</p>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col" style="padding: 35px;">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <a class="btn" href="<?php echo site_url('home/login'); ?>">Get Register Now</a>
                    </div>
