                      ...
                      <form action="<?php echo site_url('login/register'); ?>" method="post">
                          <div class="content-box">
                              <div class="basic-group">
                                  ...
                                  <div class="form-group">
                                      <label for="registration-phone"><span class="input-field-icon"><i class="fas fa-phone"></i></span> <?php echo get_phrase('mobile_number'); ?>:</label>
                                      <input type="number" class="form-control" name = "phone" id="registration-phone" placeholder="<?php echo get_phrase('01...'); ?>" value="" required>
                                  </div>
                                  <div class="form-group">
