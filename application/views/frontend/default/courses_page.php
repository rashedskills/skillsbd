...
isset($selected_price) ? "": $selected_price = "all";
 //echo $selected_category_id.'-'.$selected_level.'-'.$selected_language.'-'.$selected_rating.'-'.$selected_price.'-'.$selected_type;
...
<section class="category-course-list-area">
    <div class="container">
        <div class="category-filter-box filter-box clearfix">
            ...
            <a href="javascript::" onclick="toggleLayout('grid')" style="float: right; font-size: 19px; margin-left: 5px; color: #36373c !important;"><i class="fas fa-th"></i></a>
            <a href="javascript::" onclick="toggleLayout('list')" style="float: right; font-size: 19px; color: #36373c !important;"><i class="fas fa-th-list"></i></a>
            <a href="<?php echo site_url('home/courses'); ?>" style="float: right; font-size: 19px; margin-right: 5px; color: #36373c !important;"><i class="fas fa-sync-alt"></i></a>
        </div>
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div id="collapseFilter" class="collapse show course-filter-mobile" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body pt-0">
                            ...
                            <hr>
                            <div class="filter_type">
                                <h6><?php echo get_phrase('course_method'); ?></h6>
                                <ul>
                                    <li>
                                        <div class="">
                                            <input type="radio" id="All" name="course_type" class="course_type custom-radio" value="all" onclick="filter(this)" <?php if($selected_type == 'all') echo 'checked'; ?>>
                                            <label for="All"><?php echo get_phrase('all'); ?></label>
                                        </div>
                                        <div class="">
                                            <input type="radio" id="online" name="course_type" class="course_type custom-radio" value="online" onclick="filter(this)" <?php if($selected_type == 'online') echo 'checked'; ?>>
                                            <label for="online"><?php echo get_phrase('online'); ?></label>
                                        </div>
                                        <div class="">
                                            <input type="radio" id="classroom" name="course_type" class="course_type custom-radio" value="classroom" onclick="filter(this)" <?php if($selected_type == 'classroom') echo 'checked'; ?>>
                                            <label for="classroom"><?php echo get_phrase('classroom'); ?></label>
                                        </div>
                                        <div class="">
                                            <input type="radio" id="workshop" name="course_type" class="course_type custom-radio" value="workshop" onclick="filter(this)" <?php if($selected_type == 'workshop') echo 'checked'; ?>>
                                            <label for="workshop"><?php echo get_phrase('workshop'); ?></label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="col-lg-9">
                ...
                <nav>
                    <?php if ($selected_category_id == "all" && $selected_price == 0 && $selected_level == 'all' && $selected_type == 'all' && $selected_language == 'all' && $selected_rating == 'all'){
...
function get_url() {
    ...
    // Get selected difficulty course type
    ...
    urlSuffix = "category="+slectedCategory+"&&price="+selectedPrice+"&&course_type="+selectedType+"&&level="+selectedLevel+"&&language="+selectedLanguage+"&&rating="+selectedRating;
