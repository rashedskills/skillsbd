                          ...
                          <tbody>
                              <?php foreach ($enrol_history->result_array() as $enrol):
                                  ...
                                  <tr class="gradeU">
                                      ...
                                      <td>
                                          <b><?php echo $user_data['first_name'].' '.$user_data['last_name'].' - '.'0'.$user_data['phone'];; ?></b><br>
                                      ...
                                      <p class="text-danger"><?php echo get_phrase('last_registraion_date:').' '.date('j F, Y', strtotime($course_data['reg_last_date'])) ?></p>
