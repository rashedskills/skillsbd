        ...
        <div class="card">
            <div class="card-body">
              <div class="col-lg-12">
                ...
                <p class="text-danger">Student এর নাম এর সাথে মোবাইল নম্বর এর শেষের চারটি নম্বর অবশ্যই মিলিয়ে নিন. কোর্স এর পাশে রেজিস্ট্রেশন এর শেষ তারিখ টি দেখে নিন.</p>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" data-toggle="select2" name="user_id" id="user_id" required>
                            ...
                            <?php $user_list = $this->user_model->get_user()->result_array();
                                ...
                                <option value="<?php echo $user['id'] ?>"><?php echo $user['first_name'].' '.$user['last_name'].' - '.$user['phone'].'-'.$user['email']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                        ...
                        <select class="form-control select2" data-toggle="select2" name="course_id" id="course_id" required>
                            ...
                            <?php $course_list = $this->crud_model->get_courses()->result_array();
                                ...
                                if ($course['status'] != 'active')
                                    continue;?>
                                <option value="<?php echo $course['id'] ?>"><?php echo $course['title'].' --> '.date('j F, Y', strtotime($course['reg_last_date'])); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
