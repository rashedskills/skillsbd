...
<div class="left-side-menu left-side-menu-detached">
	...
	<!--- Sidemenu -->
		<ul class="metismenu side-nav side-nav-light">
		    ...
		    <li class="side-nav-item">
				<a href="<?php echo site_url('admin/intructors'); ?>" class="side-nav-link <?php if ($page_name == 'instructors_list') echo 'active';?>">
					<i class="dripicons-user-group"></i>
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('admin/refund'); ?>" class="side-nav-link <?php if ($page_name == 'refund')echo 'active';?>">
					<i class="dripicons-cart"></i>
					<span><?php echo get_phrase('refund'); ?></span>
				</a>
			</li>
