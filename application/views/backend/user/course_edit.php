                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="<?php echo $course_details['course_type'] == "Online" ? 'hideClassroomInfo' : ''; ?>" id="classType" >
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" id="total_hours" name="total_hours" placeholder="<?php echo get_phrase('total_hours'); ?>" value="<?php echo $course_details['total_hours']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <?php foreach ($get_resource_person->result_array() as $resource): ?>
                                                            <option value="<?php echo $resource['id'] ?>" <?php if ($course_details['my_instructor_id'] == $resource['id'])echo 'selected';?>><?php echo $resource['instructor_full_name']; ?></option>    
                                                        <?php endforeach; ?>                                                
                                                        </select>
                                                    </div>
                                                </div>
