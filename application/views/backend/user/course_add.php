                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div id="classType" style="display: none">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" id="total_classes" name="total_classes" placeholder="<?php echo get_phrase('5_sessions'); ?>">
                                                        <small>example: 1 day, half day, 5 sessions etc.</small>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="totalHours"><?php echo get_phrase('total_hours'); ?></label>
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" id="total_hours" name="total_hours" placeholder="<?php echo get_phrase('total_hours'); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="level"><?php echo get_phrase('course_resource_person'); ?></label>
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="my_instructor_id" id="my_instructor_id">
                                                        <option value="0"><?php echo get_phrase('select_resource_person'); ?></option> 
                                                        <?php foreach ($get_resource_person->result_array() as $resource): ?>
                                                            <option value="<?php echo $resource['id'] ?>"><?php echo $resource['instructor_full_name']; ?></option>    
                                                        <?php endforeach; ?>                                                
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="offset-md-2 col-md-10" style="display: none">
